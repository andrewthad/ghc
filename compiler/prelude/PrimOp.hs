...
primOpType op
  = case primOpInfo op of
    ...
    GenPrimOp _occ tyvars arg_tys res_ty ->
        mkSpecForAllTys tyvars (mkFunTysU arg_tys res_ty)
...
dyadic_fun_ty  ty = mkFunTysU [ty, ty] ty
monadic_fun_ty ty = mkFunTyU  ty ty
compare_fun_ty ty = mkFunTysU [ty, ty] intPrimTy
