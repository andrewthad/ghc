  ...
  = do { rr_name <- newNameAt (mkTyVarOcc "rep") loc
       ...
       ; let rr_tv  = mkTyVar rr_name runtimeRepTy
             ...
             cont_ty = mkInfSigmaTy ex_tvs prov_theta $
                       mkFunTysU cont_arg_tys res_ty

             fail_ty  = mkFunTyU voidPrimTy res_ty
       ...
       ; let matcher_tau   = mkFunTysU [pat_ty, cont_ty, fail_ty] res_ty
...
add_void need_dummy_arg ty
  | need_dummy_arg = mkFunTyU voidPrimTy ty
  | otherwise      = ty
