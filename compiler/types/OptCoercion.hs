...
opt_co4 env sym rep r (FunCo _r mco co1 co2)
  = ASSERT( r == _r )
    if rep
    then mkFunCo Representational mco' co1' co2'
    else mkFunCo r mco' co1' co2'
  where
    co1' = opt_co4_wrap env sym rep r co1
    co2' = opt_co4_wrap env sym rep r co2
    mco' = opt_co4_wrap env sym False Nominal mco
...
opt_trans_rule is in_co1@(FunCo r1 mco1 co1a co1b) in_co2@(FunCo r2 mco2 co2a co2b)
  = ASSERT( r1 == r2 )   -- Just like the TyConAppCo/TyConAppCo case
    fireTransRule "PushFun" in_co1 in_co2 $
    mkFunCo r1 (opt_trans is mco1 mco2) (opt_trans is co1a co2a) (opt_trans is co1b co2b)
