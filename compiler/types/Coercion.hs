...
mkFunCo r mco co1 co2
  ...
  = mkReflCo r (mkFunTy mty ty1 ty2)
...
ty_co_subst lc role ty
  ...
  where
    ...
    go r (FunTy m ty1 ty2) = mkFunCo r (go r m) (go r ty1) (go r ty2)
...
coercionKind co =
  ...
  where
    ...
    go (FunCo _ m co1 co2)  = mkFunTy <$> go m <*> go co1 <*> go co2
...
buildCoercion orig_ty1 orig_ty2 = go orig_ty1 orig_ty2
  where
    ...
    go (FunTy mco1 arg1 res1) (FunTy mco2 arg2 res2)
      = mkFunCo Nominal (go mco1 mco2) (go arg1 arg2) (go res1 res2)
